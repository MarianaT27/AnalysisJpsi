...
int Hipo_Analysis() {
    ...
    TH2F* h_delta_phi_vs_p_electron = new TH2F("h_delta_phi_vs_p_electron","#Delta#phi vs P e^{-}",150,0,10,150,-30,30);
    TH2F* h_delta_phi_vs_p_positron = new TH2F("h_delta_phi_vs_p_positron","#Delta#phi vs P e^{+}",150,0,10,150,-30,30);

    TH2F* h_delta_theta_vs_p_electron = new TH2F("h_delta_theta_vs_p_electron","#Delta#theta vs P e^{-}",150,0,10,150,-10,10);
    TH2F* h_delta_theta_vs_p_positron = new TH2F("h_delta_theta_vs_p_positron","#Delta#theta vs P e^{+}",150,0,10,150,-10,10);
...
*/
   ...
   TCanvas *can = new TCanvas("can","canvas",1000,1500);
    ...
    can->cd(3);
    h_delta_phi_vs_p_electron->Draw("colz");
    can->cd(4);
    h_delta_phi_vs_p_positron->Draw("colz");
    can->cd(5);
    h_delta_theta_vs_p_electron->Draw("colz");
    can->cd(6);
